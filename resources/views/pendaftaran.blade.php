...
<html lang="id">
	<head>
		...
		<meta name="description" content="Sistem Informasi SMK AVALON GLOBAL" />
				...
				<div class="container">
					<div class="row">
						<!-- <div class="col-sm-4 kiri">
							<strong class="logo"><a href="index.html"><img src="aset/img/logosmkpgripku.png" alt="Logo"></a></strong>
						</div> -->
				...
				<div class="hold-breadcrumbs">
					<div class="container">
						<ol class="breadcrumb breadcrumb-site">
							<li><a href="index.html">Beranda</a></li>
							<!-- <li><a href="index.html">Profil Sekolah</a></li>
						...
						<div class="container">
							...
							<div class="row">
								<div class="visi-sekolah">
									...
									<hr/>
									<p style="font-size:17px">“Unggul Dalam Prestasi Berdasarkan Sumber Daya Lingkungan Dengan Berlandaskan
Budaya Bangsa”</p>
									<p style="font-size:17px">Visi SMK AVALON GLOBAL bila telah tercipta beberapa indikator yaitu :</p>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-5 col-sm-6">
								<p>&copy; 2023 Hak Cipata Di Lindungi Oleh K5<a href="http://novay.web.id/">Project Next Generation</a></p>
							</div>
